...
// quiz.PdfFileName = "https://www.nysedregents.org/hsela/126/reela-12026-exam.pdf";
// quiz.Start();
//
// ======================================================
...
QUIZ_API.ProjectileQuiz = function(id)
{
    ...
    {
        var e = document.getElementById(self.Id + "_next");
    ...
    this.CreateUI = function()
    {
        ...
        hostPanel = document.getElementById("app") || document.body;
        hostPanel.innerHTML = "";
        ...
        if(btnCopyExamUrl)
        {
            registerClick(self.Id + "_copyexamurl", function()
            {
                VisualCode.MessageBox(self.PdfFileName);
            });
        }
...
ddlAngle.Value = "";
    ...
    function getArcPoints(angle, range, progress)
    {
        ...
        var apexHeight =
            Math.max(
                35,
                Math.min(120, range * 1.2 * Math.sin(radians) * scale / 10)
            );
